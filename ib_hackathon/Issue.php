...
<!DOCTYPE html>
 ...
 <p id="slide">Εισάγετε τα στοιχεία της επιταγής. </p>
  <ul id="menu">
  ...
  <form action="./Issue.php " method="post">
	ID ΕΠΙΤΑΓΗΣ: <p><input type="text" name="cheque_id" required /> <br><br>
	ΑΡ.ΛΟΓΑΡΙΑΣΜΟΥ: <p><input type="text" name="account" required /> <br> <br>
	ΚΩΔΙΚΟΣ ΕΠΙΤΑΓΗΣ: <p><input type="text" name="code" required /> <br> <br>
	ΠΟΣΟ: <p><input type="text" name="balance" required /> <br> <br>
	ΗΜΕΡΟΜΗΝΙΑ ΛΗΞΗΣ: <p><input type="text" name="expiration" required /> <br> <br>
	<p><input type="submit" value="Εκδοση Επιταγης" />
  </form>
  <div id="Social_media">
    <ul>
